...
<div class="container mt-4">
    ...
    {{-- ALL OTHER ROLES — full dashboard --}}
    @else
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-3">
                <a href="{{ Auth::user()->isManager()
                           ? route('rapports.inventory')
